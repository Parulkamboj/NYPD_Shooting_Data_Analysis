...
Importing Data
Importing my .csv data file from the local directory path  "C:/Users/Study/R_studio"

``` {r importing, echo=FALSE}
setwd("C:/Users/Parul/Study/R_studio")

NYPD_shooting_data <- read.csv("NYPD_Shooting_Incident_Data_Historic.csv")
```
